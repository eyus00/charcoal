...
import { List, X, ChevronLeft, ChevronRight, Play, Eye } from 'lucide-react';
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-4 md:p-8 custom-scrollbar">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-3 md:gap-6">
              {currentSeasonData?.episodes.map((episode: Episode) => {
                ...
                const isCurrentEpisode = episodeNumber === episode.episode_number && seasonNumber === selectedSeason;
          ...
          <div className={cn(
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 py-2.5 px-4 md:px-5 bg-white/5 hover:bg-white/10 disabled:opacity-30 disabled:hover:bg-white/5 text-white rounded-xl border border-white/10 transition-all text-xs md:text-sm font-bold active:scale-95"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 py-2.5 px-4 md:px-5 bg-accent hover:bg-accent/90 disabled:opacity-30 text-white rounded-xl shadow-lg shadow-accent/20 transition-all text-xs md:text-sm font-bold active:scale-95"
            >
