...
import { List, X, ChevronLeft, ChevronRight, Play, Check, Eye } from 'lucide-react';
...
const EpisodeSelector: React.FC<EpisodeSelectorProps> = ({
  ...
  return (
    <div
      className="absolute inset-0 bg-black/60 backdrop-blur-xl z-50 flex items-center justify-center animate-in fade-in zoom-in duration-300"
