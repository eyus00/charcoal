              ...
              <AnimatePresence>
                {showLeftArrow && (
                  <motion.button
                    ...
                    onClick={() => scroll('left')}
                    className="absolute left-2 md:left-4 top-[45%] z-20 -translate-y-1/2 w-10 h-10 md:w-14 md:h-14 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-full flex items-center justify-center transition-all hover:bg-accent/40 hover:border-accent/60 hover:scale-110 shadow-2xl"
                  >
              ...
              <AnimatePresence>
                {showRightArrow && (
                  <motion.button
                    ...
                    className="absolute right-2 md:right-4 top-[45%] z-20 -translate-y-1/2 w-10 h-10 md:w-14 md:h-14 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-full flex items-center justify-center transition-all hover:bg-accent/40 hover:border-accent/60 hover:scale-110 shadow-2xl"
                  >
                  ...
                  {filteredWatchlist.map((item, index) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className={cn(
                          "group flex-shrink-0 w-[140px] md:w-[180px] flex flex-col gap-3 rounded-2xl transition-all text-left border relative overflow-hidden",
