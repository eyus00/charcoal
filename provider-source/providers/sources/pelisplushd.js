...
async function extractVidhideEmbed(ctx, $) {
    ...
    for (const link of playerLinks) {
        ...
        if (/vidhide/i.test(realUrl)) {
            let embedId = 'vidhide';
            if (link.langBtn.includes('latino'))
                embedId = 'vidhide-latino';
            else if (link.langBtn.includes('castellano') || link.langBtn.includes('español'))
                embedId = 'vidhide-spanish';
            else if (link.langBtn.includes('ingles') || link.langBtn.includes('english'))
                embedId = 'vidhide-english';
