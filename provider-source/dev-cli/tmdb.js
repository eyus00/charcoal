...
export async function makeTMDBRequest(url, appendToResponse) {
    const headers = {
...
export async function getMovieMediaDetails(id) {
...
export async function getShowMediaDetails(id, seasonNumber, episodeNumber) {
